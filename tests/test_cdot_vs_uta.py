...
# import src.uta_clients.uta as uta
...
# @pytest.mark.skip(
#     reason="cdot does not include the following fields for transcripts: hgnc, tx_aseq, alt_aseq, test_exon_set_id, aes_exon_set_id, tx_exon_id, alt_exon_id, exon_aln_id"
# )
# # @pytest.mark.vcr
